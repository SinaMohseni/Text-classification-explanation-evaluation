...
var readfiles = []
var imageName;
var folder_name = "ImageNet-feedback"
var call_once = 0;
var total_doc
var doc_num
...
function image_title(){
	...
	explanation_title.text("Please review highlighted area related to \""+obj+"\" in this image: ( "+ doc_num+" / "+total_doc+ " )");
}
...
var w_size = window,
	...
	var explanation_title = d3.select("#panel").append("g").append("text").attr("class","explanation_title")
			  ...
			  .text("Please review highlight area related to \""+folder_name.toString()+"\" topic in this Article:")
			  .attr('dy','0.35em')
