...
function image_title(){
    ...
    explanation_title.text("highlighted area shows which regions of the image were important for the machine learning algorithm to identify this object: ( "+ doc_num+" / "+total_doc+ " )");
}
