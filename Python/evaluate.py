...
def read_user_data(img_folder, json_file,tot_user):
    ...
    for an_img in all_imgs:
        ...
        heatmap_path = './user_mask/'+an_img["image"]+ '.jpg'
...
def user_heatmap(img_folder,heatmap_folder,mask_folder):
    ...
    for this_img in ref_mask:
        ...
        gray_mask_path = mask_folder + this_img[0] + ".jpg"
        ...
        user_heatmap_path = heatmap_folder + this_img[0] + ".jpg"
...
def LIME_heatmap(img_folder,LIME_overlay,LIME_mask):
    ...
    for this_img in ref_mask:
        ...
        masked_heatmap = cv2.bitwise_and(heatmap,heatmap,mask = gray_mask) #this_img[1])
        ...
        LIME_overlay_path = LIME_overlay + this_img[0] + ".jpg"

        # scipy.misc.imsave(user_heatmap_path, blend_heatmap)
        cv2.imwrite(LIME_overlay_path, blend_heatmap)
        # cv2.imshow('frame',blend_heatmap)
        # cv2.waitKey(0)                
        # cv2.destroyAllWindows()
...
ref_mask = [];
img_folder = "./raw_img/"
heatmap_folder = "./user_heatmap/"
LIME_mask = "./LIME_mask/"
LIME_overlay = "./LIME_overlay/"
mask_folder = "./user_mask/"
res_folder = "./json_res/"
